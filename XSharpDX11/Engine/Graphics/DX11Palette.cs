...
public class DX11Palette : Palette
{
    public new DX11Texture Texture
    {
        get => (DX11Texture) base.Texture;
    ...
    internal DX11Palette()
    {
    }

    internal DX11Palette(ISerializer serializer)
        : base(serializer)
    {
    }

    internal DX11Palette(DX11Texture texture, int index, string name, int count)
    {
        Texture = texture;
        Index = index;
        this.name = name;
    ...
    protected override void SerializeContent(ISerializer serializer)
    {
        ...
        try
        {
            ...
            using var stream = new DX11DataStream(rect.DataPointer, width * height * sizeof(int), true, true);
    ...
    {
        DX11Texture dxPallete = (DX11Texture) palette;
