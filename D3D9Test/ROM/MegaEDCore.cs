...
namespace MMX.ROM
{
    public class MegaEDCore : IDisposable
    {
        ...
        internal byte ReadByte(int address) => ReadByte((uint) address);
        ...
        internal sbyte ReadSByte(int address) => ReadSByte((uint) address);
        ...
        internal short ReadShort(int address) => ReadShort((uint) address);
        ...
        internal ushort ReadWord(int address) => ReadWord((uint) address);
        ...
        internal static ushort ReadWord(byte[] buf, uint address) => (ushort) (buf[address] & 0xff | (buf[address + 1] << 8) & 0xff00);

        internal int ReadInt(int address) => ReadInt((uint) address);
        ...
        internal uint ReadDWord(int address) => ReadDWord((uint) address);
        ...
        internal string ReadASCIIString(int address, int count) => ReadASCIIString((uint) address, count);
        ...
        internal void WriteShort(int address, short value) => WriteShort((uint) address, value);
        ...
        internal void WriteWord(int address, ushort value) => WriteWord((uint) address, value);
        ...
        internal void WriteInt(int address, int value) => WriteInt((uint) address, value);
        ...
        internal void WriteDWord(int address, uint value) => WriteDWord((uint) address, value);
        ...
        internal void WriteASCIIString(int address, string value) => WriteASCIIString((uint) address, value);
        ...
        internal void Copy(int src, int dst, int count) => Copy((uint) src, (uint) dst, count);

        internal void Copy(uint src, uint dst, int count) => Array.Copy(rom, src, rom, dst, count);

        internal int Compare(int left, int right, int count) => Compare((uint) left, (uint) right, count);
        ...
        internal void Fill(int address, int value, int count) => Fill((uint) address, value, count);

        internal void Fill(uint address, int value, int count) => Fill(rom, address, value, count);
